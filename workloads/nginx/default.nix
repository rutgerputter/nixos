{ pkgs, ... }:
{
  ...
  services.nginx = {
      ...
      in {
        ...
        "lms-test.prutser.net"         = cert "prutser.net" // proxy "vm-moodle.services.prutser.net" 80;
        "opodsync.prutser.net"         = cert "prutser.net" // proxy "lxc-opodsync.services.prutser.net" 8080;
